                ...
                <div className={newUser ? "cont s--signup" : "cont"}>
                    <div className="form sign-in">
                        ...
                        <form onSubmit={handleSignIn(onSubmit)}>
                            <label>
                                <span>Email</span>
                                <input defaultValue="enter your email" {...registerSignIn("email", { required: true })} type="email" />
                            </label>
                            <label>
                                <span>Password</span>
                                <input defaultValue="enter your password" {...registerSignIn("password", { required: true })} type="password" />
                            </label>
