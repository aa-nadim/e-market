...
const AddProduct = ({ editProduct, restrictPermission, setEditProduct }) => {
    ...
    const onSubmit = async data => {
        ...
        if (editProduct) {
            ...
            axios.patch(`https://obscure-beach-77356.herokuapp.com/update/${editProduct._id}`, productInfo)
                .then(res => {
                    toast.dismiss(loading);
                    if (res.data) {
        ...
        axios.post('https://obscure-beach-77356.herokuapp.com/addProduct', productInfo)
            .then(res => {
                toast.dismiss(loading);
                if (res.data) {
